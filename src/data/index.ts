...
export const profileLinks = [
    ...
    {
        text: 'Email',
        href: 'mailto:jchademwiri@gmail.com',
        username: 'jchademwiri@gmail.com',
    },
];

// Personal Portfolio Items
export const portfolioItems: TPortfolioItems[] = [
    {
        ...
        links: [
            { text: 'Visit Website', href: 'https://www.sithembe.co.za' },
            {
                text: 'LinkedIn',
    ...
    },
    {
        ...
        links: [{ text: 'Visit Website', href: 'https://www.gascall.co.za' },],
    },
    // {
    // 	title: 'Solar Bank',
    // 	logo: '//seaHarvest.svg',
    ...
    // 	links: [{ text: 'Visit Website', href: 'https://www.solarbank.co.za' },],
    // },
    {
    ...
    },
    {
        ...
        technologies: ['Next.js', 'React', 'Typescript', 'Tailwind'],
        links: [
            { text: 'Visit Website', href: 'https://www.tradinginglory.co.za' },
        ],
    },
    {
        ...
        links: [
            { text: 'Visit Website', href: 'https://www.playhousemedia.net' },
            {
                text: 'YouTube',
    ...
    },
    {
        ...
        links: [
            { text: 'Visit Website', href: 'https://seaharvest.co.zw/' },
    ...
    },
    {
        ...
        technologies: ['Next.js', 'React', 'Typescript', 'Tailwind'],
        links: [
            { text: 'Visit Website', href: 'https://www.edurite.co.za' },
            { text: 'Facebook', href: 'https://www.facebook.com/eduritepro' },
            {
                text: 'LinkedIn',
                href: 'https://www.linkedin.com/company/edurite-tutors',
            },
        ],
    },
];
